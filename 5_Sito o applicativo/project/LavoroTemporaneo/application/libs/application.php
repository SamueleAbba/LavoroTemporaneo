...
class Application{
    ...
    /**
    * Attributi della calsse Application
    */
    ...
    /**
    * Costruttore della calsse Application che splitta L'url, grazie alle 
    * variabili e richiama i file, inoltre renderizza l'index in caso di errore.
    */
    ...
    /**
    * Funzione splitUrl della calsse Application che splitta L'url, grazie alle 
    * variabili e richiama i file, inoltre renderizza l'index in caso di errore.
    */
